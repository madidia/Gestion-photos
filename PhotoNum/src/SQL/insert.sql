...
INSERT INTO Img VALUES('/pe/ll.png','sgidney0@typepad.com','1','oui','10-JAN-2019');
INSERT INTO Img VALUES('/yy/aa.png','sbarlthrop1@netscape.com','1','oui',sysdate);
INSERT INTO Img VALUES('/jj/bb.png','rwellsman2@google.com.au','7','non',sysdate);
INSERT INTO Img VALUES('/ad/cc.png','bsheards3@ezinearticles.com','4','non',sysdate);
INSERT INTO Img VALUES('/sr/dd.png','cfernanando4@newsvine.com','7','oui',sysdate);

insert into UtiliseImage values ('sgidney0@typepad.com','/pp/ll.png');

insert into Code VALUES('assane', 5);
insert into CodePersonnel VALUES('assane', 5, 'sgidney0@typepad.com');

/*
insert into UtiliseImage values ('sbarlthrop1@netscape.com','/pp/ll.png');
insert into UtiliseImage values ('cfernanando4@newsvine.com','/pp/ll.png');
insert into UtiliseImage values ('cfernanando4@newsvine.com','/ad/cc.png');
insert into UtiliseImage values ('cfernanando4@newsvine.com','/jj/bb.png');

insert into Commande values (1, 'sgidney0@typepad.com', '11-JAN-19', 1, 'en cours', 3.4,'assane');
insert into Commande values (2, 'sbarlthrop1@netscape.com', '08-DEC-18', 2, 'en cours', 134.0,NULL);
insert into Commande  values (3, 'rwellsman2@google.com.au', '09-NOV-18', 3, 'en attente', 53.4,NULL);
...
insert into Impression values (1, 'A3', 'faible', 400, 1,'A3','faible','papier');
